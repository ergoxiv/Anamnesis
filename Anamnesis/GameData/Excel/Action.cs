	...
	: IExcelRow<Action>, IAnimation
{
	...
	public ActionTimeline? Timeline => this.ActionTimelineHit.RowId >= 0 ? GameDataService.ActionTimelines.GetRow((uint)this.ActionTimelineHit.RowId) : null;
	public readonly RowRef<ActionTimeline> ActionTimelineHit => new(page.Module, (uint)page.ReadUInt16(offset + 12), page.Language);
