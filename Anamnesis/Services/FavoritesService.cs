...
public class FavoritesService : ServiceBase<FavoritesService>
{
	...
	public class Favorites
	{
		...
		public List<IDye> Dyes { get; set; } = new();
		public List<Color4> Colors { get; set; } = new();
		public List<INpcBase> Models { get; set; } = new();
		public List<Item> Owned { get; set; } = new();
		public List<Glasses> Glasses { get; set; } = new();
	}
}
